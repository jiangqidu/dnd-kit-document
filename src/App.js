...
function App() {
  return (
    <Layout>
      <Header>
        <h1>dnd kit示例整理</h1>
        <a href="https://github.com/jiangqidu/dnd-kit-document" target="_blank" rel="noreferrer" style={{display: 'contents'}}>
          <svg height="32" aria-hidden="true" viewBox="0 0 16 16" version="1.1" width="32" data-view-component="true" className="github">
      ...
      <Layout>
        ...
        <Content style={{padding:24}}>
          ...
          <Route path="/dnd-kit/one-minimumDistance" component={OneMinimumDistance} />
          <Route path="/dnd-kit/one-minimumDistanceX" component={OneMinimumDistanceX} />
          <Route path="/dnd-kit/one-minimumDistanceY" component={OneMinimumDistanceY} />
          <Route path="/dnd-kit/one-horizontalAxis" component={OneHorizontalAxis} />
